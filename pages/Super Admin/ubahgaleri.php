        ...
        <div class="content-wrapper" style="background-color: #18191A;">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 style="color: #fff;margin-top:70px;"><b>Form Edit Galeri Prestasi</b></h1>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                        ...
                        <div class="col-12 mb-5 ">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <!-- /.box-header -->
                                    <div class="box-body">
                                        <form action="actionubahg.php" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <input type="hidden" name="id_prestasi" value="<?php echo $data['id_prestasi'] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="nama_prestasi">Nama Prestasi : </label>
                                                <input type="text" class="form-control" id="nama_prestasi" name="nama_prestasi" value="<?php echo $data['nama_prestasi'] ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="tingkat_prestasi">Tingkat Prestasi :</label>
                                                <input type="text" class="form-control" id="tingkat_prestasi" name="tingkat_prestasi" value="<?php echo $data['tingkat_prestasi'] ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="deskripsi_prestasi">Deskripsi Prestasi :</label>
                                                <input type="text" class="form-control" id="deskripsi_prestasi" name="deskripsi_prestasi" value="<?php echo $data['deskripsi_prestasi'] ?>">

                                            </div>


                                            <div class="form-group">
                                                <label for="foto_prestasi">Foto Prestasi:</label><br>
                                                <img style="width: 120px; margin-bottom: 10px;" src="../../dist/img/<?php echo $data['foto_prestasi']; ?>">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="foto_prestasi" name="foto_prestasi" onchange="updateFileName()">
                                                    <label class="custom-file-label" for="foto_prestasi" id="file-label"><?php echo $data['foto_prestasi']; ?></label>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="murid_id">ID Murid :</label>
                                                <input type="text" class="form-control" id="murid_id" name="murid_id" value="<?php echo $data['murid_id'] ?>">
                                            </div>
    ...
    <script>
        function updateFileName() {
            ...
            if (input.files.length > 0) {
                // Jika file baru dipilih, tampilkan namanya
                const fileName = input.files[0].name;
                label.innerHTML = fileName;
            } else {
                // Jika tidak ada file baru yang dipilih, tampilkan nama file sebelumnya
                const previousFileName = "<?php echo $data['foto_prestasi']; ?>";
                label.innerHTML = previousFileName;
            }
        }
    </script>
