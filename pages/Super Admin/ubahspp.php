...
$id = $_GET['id'];
$hasil = mysqli_query($koneksi, "SELECT * FROM pembayaran_spp WHERE id_pembayaran=$id");
        ...
        <div class="content-wrapper" style="background-color: #18191A;">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 style="color: #fff;margin-top:70px;"><b>Form Edit SPP</b></h1>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                        ...
                        <div class="col-12 mb-5 ">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <!-- /.box-header -->
                                    <div class="box-body">
                                        <form action="actioneditspp.php" method="post">
                                            <div class="form-group">
                                                <input type="hidden" name="id_pembayaran" value="<?php echo $data['id_pembayaran'] ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="tanggal_bayar">Tanggal Bayar</label>
                                                <input type="date" class="form-control" id="tanggal_bayar" name="tanggal_bayar" value="<?php echo $data['tanggal_bayar'] ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="nominal_bayar">Nominal</label>
                                                <input type="text" class="form-control" id="nominal_bayar" name="nominal_bayar" value="<?php echo $data['nominal_bayar'] ?>">
                                            </div>

                                            <div class="form-group">
                                                <label for="deadline_pembayaran">Deadline Bayar</label>
                                                <input type="date" class="form-control" id="deadline_pembayaran" name="deadline_pembayaran" value="<?php echo $data['deadline_pembayaran'] ?>">
                                            </div>
