        ...
        <div class="content-wrapper" style="background-color: #18191A;">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 style="color: #fff;margin-top:70px;"><b>Tambah Rekomendasi Lomba</b></h1>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="top-section" style="background-color: #000;color: #fff;">
                                    ...
                                    <h1 style="color: #fff; background-color:#000; text-align:center">Form Tambah Rekomendasi Lomba</h1>
                                </div>
                                <div class="card-body">
                                    <form action="proses_tambahlomba.php" method="post" enctype="multipart/form-data">
