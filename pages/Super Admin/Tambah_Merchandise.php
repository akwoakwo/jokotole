                                    ...
                                    <div id="table_div">
                                        <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="nama_merchandise" class="form-control" id="InputNamaProduk" aria-describedby="namaProduk" required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="harga_merchandise" class="form-control" id="InputHargaProduk" aria-describedby="hargaProduk" required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" name="deskripsi_merchandise" id="InputDeskripsi" rows="3"></textarea>
                                            </div>
                                            <div class="mb-3">
