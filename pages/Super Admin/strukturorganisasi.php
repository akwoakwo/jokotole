        ...
        <div class="content-wrapper" style="background-color: #18191A;">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 style="color: #fff;margin-top:70px;"><b>STRUKTUR ORGANISASI</b></h1>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-md-8">
                                            <a href="tambahstruktur.php" class="btn btn-success">Tambah</a>
                                        </div>
                                        <div class="col-md-4">
                                                    ...
                                                    <?php foreach ($hasil as $baris) : ?>
                                                        <tr>
                                                            ...
                                                            <td class="action-icons">
                                                                <a href="ubahstruktur.php?id=<?php echo $baris['id_aktor']; ?>" class="btn btn-sm btn-primary "><i class="bi bi-pencil-square"></i></a>
                                                                <a href="hapusstruktur.php?id=<?php echo $baris['id_aktor']; ?>" onClick="return confirm('Yakin?')" class="btn btn-danger btn-sm "><i class="bi bi-trash-fill"></i></a>
                                                            </td>
                                                            <?php $i++; ?>
                                                        <?php endforeach; ?>
                                                        </tr>
