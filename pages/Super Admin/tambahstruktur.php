        ...
        <div class="content-wrapper" style="background-color: #18191A;">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 style="color: #fff;margin-top:70px;"><b>Form Tambah Struktur Organisasi</b></h1>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                        ...
                        <div class="col-12 mb-5 ">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <!-- /.box-header -->
                                    <div class="box-body">
                                        <form action="actiontambahst.php" method="post" enctype="multipart/form-data">
                                            <div class="form-group mt-3">
                                                <label for="id_aktor">ID : </label>
                                                <input type="number" class="form-control" id="id_aktor" placeholder="Masukkan ID" name="id_aktor">
                                            </div>
                                            <div class="form-group">
                                                <label for="jurusan_id">ID Jurusan : </label>
                                                <input type="number" class="form-control" id="jurusan_id" placeholder="Masukkan ID Jurusan..." name="jurusan_id" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="gender" placeholder="Masukkan gender..." name="gender" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="foto" name="foto" required onchange="updateFileName()">
                                                    <label class="custom-file-label" for="foto" id="file-label">Choose file</label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="telepon_wali">Telepon Wali : </label>
                                                <input type="text" class="form-control" id="telepon_wali" placeholder="Masukkan telepon_wali..." name="telepon_wali" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="tingkatan">tingkatan : </label>
                                                <input type="text" class="form-control" id="tingkatan" placeholder="Masukkan tingkatan..." name="tingkatan" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="role" placeholder="Masukkan role..." name="role" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <a href="strukturorganisasi.php" class="btn btn-outline-primary">Kembali</a>
                                        </form>
                                    </div>
                                </div>
