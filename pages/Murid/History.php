                                        ...
                                        <table class="table table-bordered table-striped" id="taBelinventaris" style="text-align: center;">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?php echo $no++ ?></td>
                                                        <td><?php echo $baris['tingkat_old'] ?> -> <?php echo $baris['tingkat_new'] ?></td>
                                                        <td><?php echo $baris['tanggal_kenaikan'] ?></td>
                                                        <td><?php echo $baris['nama_penguji'] ?></td>
                                                        <td><?php echo $baris['status_kenaikan'] ?></td>
                                                    </tr>
                                                <?php }; ?>
                                            </tbody>
                                        </table>
