...
// Query untuk mengambil semua jadwal latihan dan nama pelatihnya
$jadwalLatihan = "SELECT jl.*, a.nama AS nama_pelatih FROM jadwal_latihan jl JOIN aktor a ON jl.pelatih_id = a.id_aktor";
$hasilJadwal = mysqli_query($koneksi, $jadwalLatihan);
                                    ...
                                    <div class="box-body">
                                        <table class="table table-bordered table-striped" id="taBeljadwalatihan" style="text-align: center;">
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                while ($baris = mysqli_fetch_assoc($hasilJadwal)) {
                                                ?>
                                                    <tr>
                                                        <td><?php echo $no++ ?></td>
                                                        <td><?php echo $baris['nama_pelatih'] ?></td>
